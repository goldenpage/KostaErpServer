...
public class PurchaseConvert {
    public static PurchaseVO from(AddFoodMaterial addFoodMaterial) {
        return PurchaseVO.builder()
                ...
                .foodMaterialWeight(addFoodMaterial.getFoodMaterialWeight())
                .totalWeight(addFoodMaterial.getTotalWeight())
                .totalPrice(addFoodMaterial.getFoodMaterialPrice() * addFoodMaterial.getFoodMaterialCount())
